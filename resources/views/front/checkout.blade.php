                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 form-input form">
                                                            <x-form.input type="text" name="addr[billing][last_name]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="addr[billing][email]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="select-items">
                                                        <x-form.input type="text" name="addr[billing][state]"
                                                            placeholder="State" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Email Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="addr[shipping][email]"
                                                            placeholder="Email Address" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>City</label>
                                                    <div class="form-input form">
                                                        <x-form.input type="text" name="addr[shipping][city]"
                                                            placeholder="City" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Region/State</label>
                                                    <div class="select-items">
                                                        <x-form.input type="text" name="addr[shipping][state]"
                                                            placeholder="State" />
                                                    </div>
                                                </div>
                                            </div>
